...
const tokenManagement = proxyquire(
    '../../../cartridges/int_reachfive/cartridge/scripts/interfaces/tokenManagement',
    {
        './serviceConfig': {
...
describe('tokenManagement', function () {
    describe('oauthToken', function () {
        it('should retrieve OAuth token', function () {
            const result = tokenManagement.oauthToken({
    ...
    describe('retrieveAccessTokenWithRefresh', function () {
        it('should retrieve access token with refresh', function () {
            const result = tokenManagement.retrieveAccessTokenWithRefresh(
                'mockRefreshToken'
            );
            expect(result).to.deep.equal({
                ok: true,
