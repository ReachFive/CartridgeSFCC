...
describe('reachFiveHelper', function () {
    ...
    beforeEach(function () {
        ...
        const ReachfiveSession = proxyquire(
    ...
    it('should return the correct value for getReachFiveDomain', function () {
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('reach5Domain')
            .returns('mockDomain');
    ...
    it('should return the correct value for getReachFiveApiKey', function () {
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('reach5ApiKey')
            .returns('mockApiKey');
    ...
    it('should return the correct value for getReachFiveClientSecret', function () {
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('reach5ClientSecret')
            .returns('mockClientSecret');
        expect(reachFiveHelper.getReachFiveClientSecret()).to.equal(
            'mockClientSecret'
        );
    });
    ...
    it('should return the correct value for getReachFiveProviderId', function () {
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('reachFiveProviderId')
            .returns('mockProviderId');
        expect(reachFiveHelper.getReachFiveProviderId()).to.equal(
            'mockProviderId'
        );
    });
    ...
    it('should return the correct value for isReachFiveEnabled', function () {
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('isReachFiveEnabled')
            .returns(true);
        expect(reachFiveHelper.isReachFiveEnabled()).to.equal(true);
    });

    it('should return the correct value for isReachFiveTransitionActive', function () {
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('isReachFiveTransitionActive')
            .returns(true);
        expect(reachFiveHelper.isReachFiveTransitionActive()).to.equal(true);
    });

    it('should return the correct value for getReachFiveTheme', function () {
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('isReach5ThemeActive')
            .returns(true);
    ...
    it('should return the correct value for getReachFiveUiSdkUrl', function () {
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('reach5UiSdkUrl')
            .returns('mockUiSdkUrl');
    ...
    it('should return the correct value for getReachFiveCoreSdkUrl', function () {
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('reach5CoreSdkUrl')
            .returns('mockCoreSdkUrl');
        expect(reachFiveHelper.getReachFiveCoreSdkUrl()).to.equal(
            'mockCoreSdkUrl'
        );
    });
    ...
    it('should return the correct value for isFastRegister', function () {
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('isReachFiveFastRegister')
            .returns(true);
        expect(reachFiveHelper.isFastRegister()).to.equal(true);
    });

    it('should return the correct value for getReachFiveManagementApiKey', function () {
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('reach5ManagementApiKey')
            .returns('mockManagementApiKey');
        expect(reachFiveHelper.getReachFiveManagementApiKey()).to.equal(
            'mockManagementApiKey'
        );
    });
    ...
    it('should return the correct value for getReachFiveManagementClientSecret', function () {
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('reach5ManagementClientSecret')
            .returns('mockManagementClientSecret');
        expect(reachFiveHelper.getReachFiveManagementClientSecret()).to.equal(
            'mockManagementClientSecret'
        );
    });
    ...
    it('should return the correct value for getReachFiveManagementScope', function () {
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('reach5ManagementScope')
            .returns('mockManagementScope');
        expect(reachFiveHelper.getReachFiveManagementScope()).to.equal(
            'mockManagementScope'
        );
    });
    ...
    it('should return the correct value for getReachFiveProfileFieldsJSON', function () {
        ...
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('reach5ProfileFieldsJSON')
            .returns(JSON.stringify(json));
        expect(reachFiveHelper.getReachFiveProfileFieldsJSON()).to.deep.equal(
            json
        );
    });
    ...
    it('should log an error if getReachFiveProfileFieldsJSON is invalid', function () {
        ...
        siteStub
            .getCurrent()
            .getCustomPreferenceValue.withArgs('reach5ProfileFieldsJSON')
            .returns(invalidJsonStr);
        expect(reachFiveHelper.getReachFiveProfileFieldsJSON()).to.equal(null);
